    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 flex items-center gap-2 z-20">
        <div className="glass px-4 py-2 rounded-full border border-white/10">
          <span className="text-sm text-white/60">Created by <span className="text-white font-medium">Fathir Ramadhan</span> <span className="text-xs text-green-400 ml-1 border border-green-500/30 px-1 rounded">v2.2 (Siap Pakai)</span></span>
        </div>
      </div>
